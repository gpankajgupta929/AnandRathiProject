...
public class EquityMethodTC14 
{
	...
	
	{
		...
		String data0 = sheet1.getRow(28).getCell(3).getStringCellValue();
	...
	public String getData1() throws Exception
	{
		...
		int data1 = (int) sheet1.getRow(28).getCell(5).getNumericCellValue();
	...
	public String getData2() throws Exception
	{
		...
		int data2 = (int) sheet1.getRow(28).getCell(9).getNumericCellValue();
	...
	public String getData3() throws Exception
	{
		...
		int data3 = (int) sheet1.getRow(28).getCell(12).getNumericCellValue();
