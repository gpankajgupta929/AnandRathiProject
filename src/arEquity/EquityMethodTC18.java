...
public class EquityMethodTC18 
{
	...
	public String getData2() throws Exception
	{
		...
		int data2 = (int) sheet1.getRow(36).getCell(9).getNumericCellValue();
	...
	public String getData3() throws Exception
	{
		...
		int data3 = (int) sheet1.getRow(36).getCell(12).getNumericCellValue();
