...
public class EquityMethodTC13 
{
	...
	
	{
		...
		String data0 = sheet1.getRow(26).getCell(3).getStringCellValue();
	...
	public String getData1() throws Exception
	{
		...
		int data1 = (int) sheet1.getRow(26).getCell(5).getNumericCellValue();
	...
	public String getData2() throws Exception
	{
		...
		int data2 = (int) sheet1.getRow(26).getCell(10).getNumericCellValue();
	...
	public String getData3() throws Exception
	{
		...
		int data3 = (int) sheet1.getRow(26).getCell(12).getNumericCellValue();
