...
public class EquityMethodTC5 
{
	...
	
	{
		...
		String data0 = sheet1.getRow(10).getCell(3).getStringCellValue();
	...
	
	{
		...
		int data0 = (int) sheet1.getRow(10).getCell(5).getNumericCellValue();
 	...
 	
 	{
 		...
 		double data0 = (double) sheet1.getRow(10).getCell(7).getNumericCellValue();
     ...
     public String getData3() throws Exception 
  	
  	{
  		...
  		int data0 = (int) sheet1.getRow(10).getCell(12).getNumericCellValue();
