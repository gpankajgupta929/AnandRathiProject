...
public class EquityMethodTC9 
{
	...
	
	{
		...
		String data0 = sheet1.getRow(18).getCell(3).getStringCellValue();
	...
	
	{
		...
		int data0 = (int) sheet1.getRow(18).getCell(5).getNumericCellValue();
...
public String getData2() throws Exception 
 	
	{
		...
		int data0 = (int) sheet1.getRow(18).getCell(10).getNumericCellValue();
...
public String getData3() throws Exception 
 	
	{
		...
		int data0 = (int) sheet1.getRow(18).getCell(12).getNumericCellValue();
