...
public class EquityMethodTC26 
{
	...
	
	{
		...
		String data0 = sheet1.getRow(52).getCell(3).getStringCellValue();
	...
	public String getData1() throws Exception
	{
		...
		int data1 = (int) sheet1.getRow(52).getCell(5).getNumericCellValue();
	...
	public String getData2() throws Exception
	{
		...
		double data2 = (double) sheet1.getRow(52).getCell(7).getNumericCellValue();
	...
	public String getData3() throws Exception
	{
		...
		int data3 = (int) sheet1.getRow(52).getCell(9).getNumericCellValue();
	...
	public String getData4() throws Exception
	{
		...
		int data3 = (int) sheet1.getRow(52).getCell(12).getNumericCellValue();
