...
public class EquityMethodTC15
{
	...
	
	{
		...
		String data0 = sheet1.getRow(30).getCell(3).getStringCellValue();
	...
	public String getData1() throws Exception
	{
		...
		int data1 = (int) sheet1.getRow(30).getCell(5).getNumericCellValue();
	...
	public String getData2() throws Exception
	{
		...
		int data2 = (int) sheet1.getRow(30).getCell(9).getNumericCellValue();
	...
	public String getData3() throws Exception
	{
		...
		int data3 = (int) sheet1.getRow(30).getCell(12).getNumericCellValue();
