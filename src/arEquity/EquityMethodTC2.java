...
public class EquityMethodTC2 
{
	...
	public String getData2() throws Exception
	{
	       ...
	       double data2 = (double) sheet1.getRow(4).getCell(7).getNumericCellValue();
	...
	/*public String getData3() throws Exception
	{
	       ...
	       int data3 = (int) sheet1.getRow(4).getCell(9).getNumericCellValue();
