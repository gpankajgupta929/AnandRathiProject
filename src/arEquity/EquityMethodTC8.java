...
public class EquityMethodTC8 
{
	...
	
	{
		...
		String data0 = sheet1.getRow(16).getCell(3).getStringCellValue();
	...
	
	{
		...
		int data0 = (int) sheet1.getRow(16).getCell(5).getNumericCellValue();
 	...
 	
 	{
 		...
 		double data0 = (double) sheet1.getRow(16).getCell(7).getNumericCellValue();
