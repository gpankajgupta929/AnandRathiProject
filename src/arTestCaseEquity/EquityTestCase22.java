...
import arEquity.EquityMethodTC22;

public class EquityTestCase22
{
    ...
    public void BuyOrder() throws Exception
    {
		...
		rupee1.get((new EquityMethodTC1()).getData()); //Invoking URL on Browser
		 ...
		 Thread.sleep(2000);
		   ...
		   rupee1.findElement(By.xpath("//*[@id=\"symbollookup\"]")).sendKeys(new EquityMethodTC22().getData0()); //Inputting searching value in Search Pop-Up Screen
		 ...
		 //-->/html/body/div[8]/ul/li[1] For capturing 1st Value
		   ...
		   rupee1.findElement(By.xpath("//*[@id=\"orderLot\"]")).sendKeys(new EquityMethodTC22().getData1()); //Setting Order Quantity value
		   ...
		   js1.executeScript("arguments[0].value = " + new EquityMethodTC22().getData2(), dl);
		   
		   Select drpProductType = new Select(rupee1.findElement(By.id("orderProduct")));
		   drpProductType.selectByVisibleText("MIS");
		   
		   rupee1.findElement(By.xpath("//input[@id=\"orderTriggerPrice\"]")).sendKeys(new EquityMethodTC22().getData3());
		   ...
		   rupee1.findElement(By.xpath("//input[@id=\"orderDisclosedQuantity\" and @name=\"discqty\"]")).sendKeys(new EquityMethodTC22().getData4()); //Setting Disclose Quantity
