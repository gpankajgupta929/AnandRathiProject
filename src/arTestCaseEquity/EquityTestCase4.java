...
import arEquity.EquityMethodTC4;

public class EquityTestCase4
{
	 @Test (description = "This Test will Place a Order in Sell with Modification.")
     ...
     rupee1.findElement(By.xpath("//*[@id=\"2ndpage\"]/div[3]")).click(); //Clicking on Submit Button
	   ...
	   rupee1.findElement(By.xpath("//*[@id=\"symbollookup\"]")).sendKeys(new EquityMethodTC4().getData0()); //Inputting searching value in Search Pop-Up Screen
	   ...
	   rupee1.findElement(By.id("sell_active")).click(); //Clicking on Sell Action on Placing Order Screen
	   
	   rupee1.findElement(By.xpath("//*[@id=\"orderLot\"]")).clear(); //Clearing By-Default value from Quantity field
	   
	  rupee1.findElement(By.xpath("//*[@id=\"orderLot\"]")).sendKeys(new EquityMethodTC4().getData1()); //Setting Order Quantity value
	  
	  Select drpOrder = new Select(rupee1.findElement(By.id("orderType"))); 
	  drpOrder.selectByVisibleText("SL"); //Selecting Order type from Dropdown
	   ...
	   js1.executeScript("arguments[0].value = " + new EquityMethodTC4().getData2(), dl);
	  	  
	  Thread.sleep(2000);
	  
	  Select drpProduct = new Select(rupee1.findElement(By.id("orderProduct"))); 
	  drpProduct.selectByVisibleText("MIS"); //Selecting Product type from Dropdown
	  
	  rupee1.findElement(By.xpath("//input[@id=\"orderTriggerPrice\"]")).sendKeys(new EquityMethodTC4().getData3());  //Setting Trigger Price
	  ...
	  rupee1.findElement(By.xpath("//input[@name=\"discqty\" or @id=\"orderDisclosedQuantity\"]")).sendKeys(new EquityMethodTC4().getData4()); //Setting Disclosed Quantity
	   ...
	   String statuString2 = rupee1.findElement(By.xpath("//*[@id=\"orderBookGrid\"]/div[5]/div/div[1]/div[4]/div")).getText(); //Path for Status Grid Text
		...
		//*[@id="orderBookGrid"]/div[5]/div/div[1]/div[4]
		 if(statuString2.equalsIgnoreCase("open"))
		   {
			   System.out.println("Text is present 1.0.");
		   ...
		   {
			   //rupee.switchTo().window(statuString);
			   System.out.println("Text is absent 1.0.");
