...
import arEquity.EquityMethodTC11;

public class EquityTestCase11
{
	@Test (description = "Place Order Entry > MIS PRODUCT > MKT Order Type > Validity DAY")
    public void BuyOrder() throws Exception
    {
		...
		rupee1.get((new EquityMethodTC1()).getData()); //Invoking URL on Browser
		 ...
		 Thread.sleep(2000);
		   ...
		   rupee1.findElement(By.xpath("//*[@id=\"symbollookup\"]")).sendKeys(new EquityMethodTC11().getData0()); //Inputting searching value in Search Pop-Up Screen
		 ...
		 //-->/html/body/div[8]/ul/li[1] For capturing 1st Value
		   ...
		   rupee1.findElement(By.xpath("//*[@id=\"orderLot\"]")).sendKeys(new EquityMethodTC11().getData1()); //Setting Order Quantity value
		   ...
		   rupee1.findElement(By.xpath("//input[@id=\"orderMktprotection\" and @name=\"mktprotection\"]")).sendKeys(new EquityMethodTC11().getData2()); //Setting Market Protection value
		   ...
		   rupee1.findElement(By.xpath("//input[@id=\"orderDisclosedQuantity\" and @name=\"discqty\"]")).sendKeys(new EquityMethodTC11().getData3()); //Setting Disclose Quantity
