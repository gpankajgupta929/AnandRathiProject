...
import arEquity.EquityMethodTC10;

public class EquityTestCase10
{
	@Test (description = "Place Order Entry > CNC PRODUCT > MKT Order Type > Validity DAY")
    public void BuyOrder() throws Exception
    {
		...
		rupee1.get((new EquityMethodTC1()).getData()); //Invoking URL on Browser
		 ...
		 Thread.sleep(2000);
		   ...
		   rupee1.findElement(By.xpath("//*[@id=\"symbollookup\"]")).sendKeys(new EquityMethodTC10().getData0()); //Inputting searching value in Search Pop-Up Screen
		 ...
		 //-->/html/body/div[8]/ul/li[1] For capturing 1st Value
		   ...
		   rupee1.findElement(By.id("sell_active")).click(); //Clicking on Sell Action
		   
		   rupee1.findElement(By.xpath("//*[@id=\"orderLot\"]")).clear(); //Clearing By-Default value from Quantity field
		   
		   rupee1.findElement(By.xpath("//*[@id=\"orderLot\"]")).sendKeys(new EquityMethodTC10().getData1()); //Setting Order Quantity value
		  
		   Select drpOrderType = new Select(rupee1.findElement(By.id("orderType")));
		   drpOrderType.selectByVisibleText("MKT");
		   
		   rupee1.findElement(By.xpath("//input[@id=\"orderMktprotection\" and @name=\"mktprotection\"]")).clear();
		   
		   rupee1.findElement(By.xpath("//input[@id=\"orderMktprotection\" and @name=\"mktprotection\"]")).sendKeys(new EquityMethodTC10().getData2()); //Setting Market Protection value
		   ...
		   rupee1.findElement(By.xpath("//input[@id=\"orderDisclosedQuantity\" and @name=\"discqty\"]")).sendKeys(new EquityMethodTC10().getData3()); //Setting Disclose Quantity
		 ...
		 rupee1.findElement(By.id("btnConfirmOrder")).click(); //Clicking Submit Order button
		  ...
		  rupee1.findElement(By.xpath("//*[@id=\"backoff\"]/a")).click(); //Clicking on Reports
		   ...
		   String statuString = rupee1.findElement(By.xpath("//*[@id=\"orderBookGrid\"]/div[5]/div/div[1]/div[4]/div")).getText(); //Path for Status Grid Text
			 ...
			 if(statuString.equalsIgnoreCase("open"))
			   {
				 System.out.println("Text is present.");
				   ...
				   rupee1.findElement(By.xpath("/html/body/section[25]/div/div/div/div/div/div/div[2]/div/div/div/div/div/div[5]/div/div[1]/div[5]")).click(); //Clicking on Orderbook list for Modify
