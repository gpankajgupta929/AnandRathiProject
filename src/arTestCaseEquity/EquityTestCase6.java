...
import arEquity.EquityMethodTC6;

public class EquityTestCase6
{
     ...
     public void BuyOrder() throws Exception 
      ...
      ChromeOptions notify1 = new ChromeOptions();
	   ...
	   rupee1.findElement(By.xpath("//*[@id=\"symbollookup\"]")).sendKeys(new EquityMethodTC6().getData0()); //Inputting searching value in Search Pop-Up Screen
	   ...
	   rupee1.findElement(By.xpath("//*[@id=\"orderLot\"]")).sendKeys(new EquityMethodTC6().getData1()); //Setting Order Quantity value
	   ...
	   rupee1.findElement(By.xpath("//input[@name=\"discqty\" or @id=\"orderDisclosedQuantity\"]")).sendKeys(new EquityMethodTC6().getData2()); //Setting Disclosed Quantity
