...
import arEquity.EquityMethodTC14;

public class EquityTestCase14
{
	@Test (description = "Place Order Entry > CNC PRODUCT > SL-M Order Type > Validity DAY")
    public void BuyOrder() throws Exception
    {
		...
		rupee1.get((new EquityMethodTC1()).getData()); //Invoking URL on Browser
		 ...
		 Thread.sleep(2000);
		   ...
		   rupee1.findElement(By.xpath("//*[@id=\"symbollookup\"]")).sendKeys(new EquityMethodTC14().getData0()); //Inputting searching value in Search Pop-Up Screen
		 ...
		 //-->/html/body/div[8]/ul/li[1] For capturing 1st Value
		   ...
		   rupee1.findElement(By.xpath("//*[@id=\"orderLot\"]")).sendKeys(new EquityMethodTC14().getData1()); //Setting Order Quantity value
		  
		   Select drpOrderType = new Select(rupee1.findElement(By.id("orderType")));
		   drpOrderType.selectByVisibleText("SL-M");
		   
		   rupee1.findElement(By.xpath("//input[@id=\"orderTriggerPrice\"]")).sendKeys(new EquityMethodTC14().getData2());
		   ...
		   rupee1.findElement(By.xpath("//input[@id=\"orderDisclosedQuantity\" and @name=\"discqty\"]")).sendKeys(new EquityMethodTC14().getData3()); //Setting Disclose Quantity
