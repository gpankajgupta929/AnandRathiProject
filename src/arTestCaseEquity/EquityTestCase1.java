...
public class EquityTestCase1 
{
     @Test (description = "Place Order Entry > CNC PRODUCT > Limit Order Type > Validity day.")
 ...
 
	{
		ChromeOptions notify = new ChromeOptions();
		 ...
		 WebDriver rupee = new ChromeDriver(notify);
		   ...
		   rupee.manage().timeouts().pageLoadTimeout(70, TimeUnit.SECONDS);
		   
		   rupee.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
		   
		   rupee.get((new EquityMethodTC1()).getData()); //Invoking URL on Browser

		   rupee.findElement(By.xpath("//*[@id=\"id\"]")).sendKeys(new EquityMethodTC1().getData1()); //Inputting User ID
		   
		 Thread.sleep(2000);
		   
		   rupee.findElement(By.id("loginb1")).click(); //Clicking on Validate Button
		   
		   rupee.findElement(By.id("newpassword")).sendKeys(new EquityMethodTC1().getData2()); //Inputting Password
		   
		   rupee.findElement(By.xpath("//*[@id=\"2ndpage\"]/div[2]/div/label")).click(); //Checking Images's checkbox
		   
		   /*WebDriver wait = (WebDriver) new WebDriverWait(rupee, 20);
		   ((FluentWait<WebDriver>) wait).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\\\"resetbtn\"")));*/
		   
		   //rupee.switchTo().frame("Submit");
		   
		   rupee.findElement(By.xpath("//*[@id=\"2ndpage\"]/div[3]")).click(); //Clicking on Submit Button
		   
		   rupee.findElement(By.xpath("//*[@id=\"ans_1\"]")).sendKeys(new EquityMethodTC1().getData3(false)); //Inputting Security answer No.1
		   
		   rupee.findElement(By.xpath("//*[@id=\"ans_2\"]")).sendKeys(new EquityMethodTC1().getData3(true)); //Inputting Security answer No.2
		  ...
		  //rupee.findElement(By.xpath("//*[@id=\"search\"]/div/div/div/div/div[1]/div[2]/button")).click(); //Closing Search Pop-Up Screen
		   
		  /*Select drpInstrument = new Select(rupee.findElement(By.id("addSymbolInst")));
		  drpExchange.selectByVisibleText("FUTCOM");*/  //Selecting value from Instrument dropdown
		   
		   //rupee.findElement(By.xpath("//select[@id=\"addSymbolInst\"]/option[4]")).click();
		   
		   rupee.findElement(By.xpath("//*[@id=\"symbollookup\"]")).sendKeys(new EquityMethodTC1().getData4()); //Inputting searching value in Search Pop-Up Screen
	       
		   //Thread.sleep(2000);
		   
		   rupee.findElement(By.xpath("/html/body/div[8]/ul/li[1]/div")).click(); //Capturing value from AutoSuggested List
		  
		   //-> /html/body/div[8]/ul/li[1]/div ->For capturing 1st value
		   //-> /html/body/div[8]/ul/li[2] ->For capturing 2nd value
		   
		   WebElement element = rupee.findElement (By.xpath ("//*[@id=\"TradeSymbol\"]/img"));
		   ...
		   rupee.findElement(By.xpath("//*[@id=\"orderLot\"]")).sendKeys(new EquityMethodTC1().getData5()); //Setting Order Quantity value
		   //sendKeys only accept CharSequences
		   
		   rupee.findElement(By.id("orderPrice")).clear(); //Clearing existing Price value
		   WebElement dl = rupee.findElement(By.id("orderPrice"));
		   JavascriptExecutor js1 = (JavascriptExecutor) rupee;		 
		   
		   js1.executeScript("arguments[0].value = " + new EquityMethodTC1().getData6(), dl);
		   
		   Thread.sleep(2000);
		   
		   //rupee.findElement(By.id("orderPrice")).sendKeys(new EquityMethodTC1().getData5()); //Setting order price
		   
		   rupee.findElement(By.xpath("//*[@id=\"more_less_fields\"]/h6/a")).click(); //Clicking on More Fields
		   
		   rupee.findElement(By.xpath("//input[@name=\"discqty\" or @id=\"orderDisclosedQuantity\"]")).clear();
		   rupee.findElement(By.xpath("//input[@name=\"discqty\" or @id=\"orderDisclosedQuantity\"]")).sendKeys(new EquityMethodTC1().getData7()); //Setting Disclosed Quantity
		   
		 //input[@name=\"discqty\" or @id=\"orderDisclosedQuantity\"]
		   
		   rupee.findElement(By.id("btnConfirmOrder")).click(); //Clicking Submit Order button
		   
		   /*String enterQty = rupee.findElement(By.id("//*[@id=\"orderLot\"]")).getText();
		   
		   if(enterQty.matches(enterQty))
				   {
		   ...
		   rupee.findElement(By.id("action_model1")).click(); //Clicking on Order Confirmation button
		  ...
		  /*Thread.sleep(2000);  //-/html/body/section[5]/div/div/div/div/div/div[3]/button[1]
   ...
   @Test (priority = 1)
  public void OrderModificationHigh() throws InterruptedException
  {
	  ChromeOptions notify = new ChromeOptions();
		 notify.addArguments("--disable-notifications");
		 ...
		 WebDriver rupee = new ChromeDriver(notify);
		   ...
		   rupee.get("https://tradexpress.rathi.com/ITSAR/userMaster/login");

		   rupee.findElement(By.xpath("//*[@id=\"id\"]")).sendKeys("E935489"); //Inputting User ID
		   
	       Thread.sleep(2000);
		   
		   rupee.findElement(By.id("loginb1")).click(); //Clicking on Validate Button
		   
		   rupee.findElement(By.id("newpassword")).sendKeys("abc123"); //Inputting Password
		   
		   rupee.findElement(By.xpath("//*[@id=\"2ndpage\"]/div[2]/div/label")).click(); //Checking Images's checkbox
		   
           rupee.findElement(By.xpath("//*[@id=\"2ndpage\"]/div[3]")).click(); //Clicking on Submit Button
		   
		   rupee.findElement(By.xpath("//*[@id=\"ans_1\"]")).sendKeys("a"); //Inputting Security answer No.1
		   
		   rupee.findElement(By.xpath("//*[@id=\"ans_2\"]")).sendKeys("a"); //Inputting Security answer No.2
		...
		//*[@id="orderBookGrid"]/div[5]/div/div[1]/div[4]
		 if(statuString.equalsIgnoreCase("open"))
		   ...
		   /*if(rupee.findElements(By.xpath("//*[@id=\"orderBookGrid\"]/div[5]/div/div[1]/div[4]")).size() != 0)
		   {
		   ...
		   /*Boolean isPresent = rupee.findElements(By.xpath("//*[@id=\"orderBookGrid\"]/div[5]/div/div[1]/div[4]")).size() > 0;
		   System.out.println("Text is there.." + isPresent);*/
  ...
  /*}
    ...
    @Test (priority = 1)
    public void OrderModificationLow() throws InterruptedException
   {
	  ChromeOptions notify = new ChromeOptions();
		 notify.addArguments("--disable-notifications");
