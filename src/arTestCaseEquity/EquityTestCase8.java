...
import arEquity.EquityMethodTC8;

public class EquityTestCase8
{
	@Test (description = "Sell Order Entry > CNC PRODUCT > Limit Order Type > Validity IOC")
    public void SellOrder() throws Exception
    {
		...
		rupee1.manage().timeouts().pageLoadTimeout(70, TimeUnit.SECONDS);
		...
		rupee1.get((new EquityMethodTC1()).getData()); //Invoking URL on Browser
		 ...
		 Thread.sleep(2000);
		   ...
		   rupee1.findElement(By.xpath("//*[@id=\"symbollookup\"]")).sendKeys(new EquityMethodTC8().getData0()); //Inputting searching value in Search Pop-Up Screen
		 ...
		 //-->/html/body/div[8]/ul/li[1] For capturing 1st Value
		   ...
		   rupee1.findElement(By.xpath("//*[@id=\"orderLot\"]")).sendKeys(new EquityMethodTC8().getData1()); //Setting Order Quantity value
		   ...
		   js1.executeScript("arguments[0].value = " + new EquityMethodTC8().getData2(), dl);
		 ...
		 rupee1.findElement(By.id("btnConfirmOrder")).click(); //Clicking Submit Order button
		  ...
		  Thread.sleep(2000);
		   ...
		   String statuString1 = rupee1.findElement(By.xpath("//div[@id=\"orderBookGrid\"]/div[5]/div/div[1]/div[4]")).getText(); //Path for Status Grid Text
			 ...
			 if(statuString1.equalsIgnoreCase("cancelled"))
			   {
				   System.out.println("Preopen ATO unmatched..");
				   
				   rupee1.findElement(By.xpath("/html/body/section[1]/nav/div/div[3]/ul/li[10]/a/span")).click(); //Clicking on Power Button to Signout
				   Thread.sleep(2000);
				   rupee1.findElement(By.xpath("/html/body/section[5]/div/div/div/div/div/div[3]/button[2]")).click(); //Clicking Ok button of Confirm Message screen
			   ...
			   else
			   {
				   ...
				   rupee1.findElement(By.xpath("//*[@id=\"mainmenu\"]/ul/li[10]")).click(); //Clicking on Power Button to Signout
