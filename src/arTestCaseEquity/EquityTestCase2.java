...
import arEquity.EquityMethodTC2;

public class EquityTestCase2
{
     ...
     rupee1.findElement(By.xpath("//*[@id=\"2ndpage\"]/div[3]")).click(); //Clicking on Submit Button
	   ...
	   //rupee1.findElement(By.xpath("//*[@id=\"addSymbolInst\"]/option[2]")).click(); //Selecting FUTSTK option
	   
	   rupee1.findElement(By.xpath("//*[@id=\"symbollookup\"]")).sendKeys(new EquityMethodTC2().getData0()); //Inputting searching value in Search Pop-Up Screen
	  ...
	  rupee1.findElement(By.xpath("//*[@id=\"orderLot\"]")).sendKeys(new EquityMethodTC2().getData1()); //Setting Order Quantity value
	  ...
	  //rupee1.findElement(By.id("orderPrice")).sendKeys("70.70");
	  
	  rupee1.findElement(By.id("orderPrice")).clear(); //Clearing existing Price value
	   WebElement dl = rupee1.findElement(By.id("orderPrice"));
	   JavascriptExecutor js1 = (JavascriptExecutor) rupee1;		 
	   
	   js1.executeScript("arguments[0].value = " + new EquityMethodTC2().getData2(), dl);
	  ...
	  //rupee1.findElement(By.xpath("//input[@id=\"orderTriggerPrice\"]")).sendKeys(new EquitySellOrderMethodTC1b().getData2()); //Setting Trigger Price for Combination of SL-MIS
	  
	  rupee1.findElement(By.xpath("//input[@name=\"discqty\" or @id=\"orderDisclosedQuantity\"]")).clear();
	  rupee1.findElement(By.xpath("//input[@name=\"discqty\" or @id=\"orderDisclosedQuantity\"]")).sendKeys(new EquityMethodTC2().getData3()); //Setting Disclosed Quantity
