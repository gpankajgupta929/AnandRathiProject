...
import arEquity.EquityMethodTC9;

public class EquityTestCase9
{
	 @Test (description = "Buy Market Order Entry > MTF PRODUCT > Validity Day")
     public void BuyOrder() throws Exception 
      ...
      ChromeOptions notify1 = new ChromeOptions();
	   ...
	   rupee1.findElement(By.xpath("//*[@id=\"symbollookup\"]")).sendKeys(new EquityMethodTC9().getData0()); //Inputting searching value in Search Pop-Up Screen
	   ...
	   rupee1.findElement(By.id("buy_active")).click(); //Clicking on Sell Action
	   
	   rupee1.findElement(By.xpath("//*[@id=\"orderLot\"]")).clear(); //Clearing By-Default value from Quantity field
	   
	   rupee1.findElement(By.xpath("//*[@id=\"orderLot\"]")).sendKeys(new EquityMethodTC9().getData1()); //Setting Order Quantity value
		  
	   Select drpOrderType = new Select(rupee1.findElement(By.id("orderType")));
	   drpOrderType.selectByVisibleText("MKT"); //Setting order type as Market.
	   
	   rupee1.findElement(By.xpath("//input[@id=\"orderMktprotection\" and @name=\"mktprotection\"]")).clear();
	   
	   rupee1.findElement(By.xpath("//input[@id=\"orderMktprotection\" and @name=\"mktprotection\"]")).sendKeys(new EquityMethodTC9().getData2()); //Setting Market Protection value
	   ...
	   rupee1.findElement(By.xpath("//input[@id=\"orderDisclosedQuantity\" and @name=\"discqty\"]")).sendKeys(new EquityMethodTC9().getData3()); //Setting Disclose Quantity
		   ...
		   String statuString1 = rupee1.findElement(By.xpath("//div[@id=\"orderBookGrid\"]/div[5]/div/div[1]/div[4]")).getText(); //Path for Status Grid Text
			...
			rupee1.findElement(By.xpath("//*[@id=\"quantity_ipfield\"]/span[2]/button")).click(); //Clicking on Plus icon increase Quantity
		     ...
		     rupee1.findElement(By.xpath("//*[@id=\"backoff\"]/a")).click(); //Clicking on Reports
			   ...
			   String statuString2 = rupee1.findElement(By.xpath("//div[@id=\"orderBookGrid\"]/div[5]/div/div[1]/div[4]")).getText(); //Path for Status Grid Text
			   
				//*[@id="orderBookGrid"]/div[5]/div/div[1]/div[4]
				 if(statuString2.equalsIgnoreCase("trigger pending"))
				   {
