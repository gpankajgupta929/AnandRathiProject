...
import arEquity.EquityMethodTC3;

public class EquityTestCase3
{
	 @Test (description = "This Test will Place a Order in Buy with Modification.")
     ...
     rupee1.findElement(By.xpath("//*[@id=\"2ndpage\"]/div[3]")).click(); //Clicking on Submit Button
	   ...
	   //rupee1.findElement(By.xpath("//select[@id=\"addSymbolInst\"]/option[2]")).click(); //Setting FUTSTK Instrument
	   
	   rupee1.findElement(By.xpath("//*[@id=\"symbollookup\"]")).sendKeys(new EquityMethodTC3().getData0()); //Inputting searching value in Search Pop-Up Screen
	   ...
	   rupee1.findElement(By.id("buy_active")).click();
	   
	   rupee1.findElement(By.xpath("//*[@id=\"orderLot\"]")).clear(); //Clearing By-Default value from Quantity field
	   
	  rupee1.findElement(By.xpath("//*[@id=\"orderLot\"]")).sendKeys(new EquityMethodTC3().getData1()); //Setting Order Quantity value
	  
	  Select drpOrderType = new Select(rupee1.findElement(By.id("orderType")));
	   drpOrderType.selectByVisibleText("SL"); //Setting Order type Stop-Loss.
	   ...
	   js1.executeScript("arguments[0].value = " + new EquityMethodTC3().getData2(), dl);
	  
	  //rupee1.findElement(By.id("orderPrice")).sendKeys(new BuyOrderMethodTC2a().getData1()); //Setting order price
	  	  
	  Thread.sleep(2000);
	  
	  //rupee1.findElement(By.xpath("//select[@id=\"orderProduct\"]/option[4]")).click(); //Selecting Product type from Dropdown
	  	  
	  //rupee1.findElement(By.xpath("//input[@id=\"orderMktprotection\"]")).sendKeys(new BuyOrderMethodTC2a().getData1());  //Setting Market Protection value
	  
	  rupee1.findElement(By.xpath("//input[@id=\"orderTriggerPrice\"]")).sendKeys(new EquityMethodTC3().getData3());  //Setting Trigger Price
	  ...
	  rupee1.findElement(By.xpath("//input[@name=\"discqty\" or @id=\"orderDisclosedQuantity\"]")).sendKeys(new EquityMethodTC3().getData4()); //Setting Disclosed Quantity
	   ...
	   String statuString2 = rupee1.findElement(By.xpath("//*[@id=\"orderBookGrid\"]/div[5]/div/div[1]/div[4]/div")).getText(); //Path for Status Grid Text
		...
		//-->/html/body/div[4]/div/div/div/div/div[2]/div[1]/div/div[1]/div[14]/div/div/div[5]/button
		 ...
		 Thread.sleep(2000);
          ...
          rupee1.findElement(By.xpath("//div[@id=\"Confirmscreen_view\"]/div/div/div/div/div[3]/*")).click(); //Clicking on Pop-Up Message screen
