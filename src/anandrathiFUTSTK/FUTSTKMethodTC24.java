...
public String getData2() throws Exception 
{
	...
	int data2 = (int) sheet1.getRow(48).getCell(9).getNumericCellValue();
...
public String getData3() throws Exception 
{
	...
	int data2 = (int) sheet1.getRow(48).getCell(10).getNumericCellValue();
