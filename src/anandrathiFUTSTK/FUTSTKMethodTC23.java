...
public String getData2() throws Exception 
{
	...
	int data2 = (int) sheet1.getRow(46).getCell(9).getNumericCellValue();
...
public String getData3() throws Exception 
{
	...
	int data2 = (int) sheet1.getRow(46).getCell(10).getNumericCellValue();
