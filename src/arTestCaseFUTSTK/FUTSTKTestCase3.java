...
import anandrathiFUTSTK.FUTSTKMethodTC3;

import org.testng.annotations.*;

public class FUTSTKTestCase3
{
     @Test (description = "Buy Order Entry > Limit Order Type > MIS PRODUCT >  Validity Day only.")
 ...
 
	{
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"symbollookup\"]")).sendKeys(new FUTSTKMethodTC3().getData0()); //Inputting searching value in Search Pop-Up Screen
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"orderLot\"]")).sendKeys(new FUTSTKMethodTC3().getData1()); //Setting Order Quantity value
	   ...
	   js1.executeScript("arguments[0].value = " + new FUTSTKMethodTC3().getData2(), dl);
