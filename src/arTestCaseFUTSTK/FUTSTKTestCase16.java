...
import anandrathiFUTSTK.FUTSTKMethodTC15;

import org.testng.annotations.*;

public class FUTSTKTestCase16
{
     @Test (description = "Sell Order Entry > MKT Order Type > MIS PRODUCT >  Validity IOC.")
 ...
 
	{
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"symbollookup\"]")).sendKeys(new FUTSTKMethodTC15().getData0()); //Inputting searching value in Search Pop-Up Screen
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"orderLot\"]")).sendKeys(new FUTSTKMethodTC15().getData1()); //Setting Order Quantity value
	   ...
	   rupee.findElement(By.xpath("//input[@id=\"orderMktprotection\" and @name=\"mktprotection\"]")).sendKeys(new FUTSTKMethodTC15().getData2()); //Setting Market Protection value
