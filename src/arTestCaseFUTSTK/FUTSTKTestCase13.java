...
import anandrathiFUTSTK.FUTSTKMethodTC13;

import org.testng.annotations.*;

public class FUTSTKTestCase13
{
     @Test (description = "Place Order Entry > MKT Order Type > NRML PRODUCT >  Validity IOC.")
 ...
 
	{
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"symbollookup\"]")).sendKeys(new FUTSTKMethodTC13().getData0()); //Inputting searching value in Search Pop-Up Screen
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"orderLot\"]")).sendKeys(new FUTSTKMethodTC13().getData1()); //Setting Order Quantity value
	   ...
	   rupee.findElement(By.xpath("//input[@id=\"orderMktprotection\" and @name=\"mktprotection\"]")).sendKeys(new FUTSTKMethodTC13().getData2()); //Setting Market Protection value
