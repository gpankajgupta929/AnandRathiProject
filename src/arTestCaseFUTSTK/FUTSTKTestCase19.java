...
import anandrathiFUTSTK.FUTSTKMethodTC19;

import org.testng.annotations.*;

public class FUTSTKTestCase19
{
     @Test (description = "Buy Order Entry > SL Order Type > MIS PRODUCT >  Validity DAY.")
 ...
 
	{
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"symbollookup\"]")).sendKeys(new FUTSTKMethodTC19().getData0()); //Inputting searching value in Search Pop-Up Screen
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"orderLot\"]")).sendKeys(new FUTSTKMethodTC19().getData1()); //Setting Order Quantity value
	   ...
	   js1.executeScript("arguments[0].value = " + new FUTSTKMethodTC19().getData2(), dl);
	   ...
	   rupee.findElement(By.xpath("//input[@id=\"orderTriggerPrice\" and @name=\"trggprice\"]")).sendKeys(new FUTSTKMethodTC19().getData3()); //Setting Trigger Price
