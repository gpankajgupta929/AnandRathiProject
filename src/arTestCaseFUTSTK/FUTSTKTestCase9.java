...
import anandrathiFUTSTK.FUTSTKMethodTC9;

import org.testng.annotations.*;

public class FUTSTKTestCase9 
{
     @Test (description = "Place Order Entry > MKT Order Type > NRML PRODUCT > Validity Day.")
 ...
 
	{
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"symbollookup\"]")).sendKeys(new FUTSTKMethodTC9().getData0()); //Inputting searching value in Search Pop-Up Screen
	   
	   rupee.findElement(By.xpath("/html/body/div[8]/ul/li[2]/div")).click(); //Capturing value from AutoSuggested List
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"orderLot\"]")).sendKeys(new FUTSTKMethodTC9().getData1()); //Setting Order Quantity value
	   ...
	   rupee.findElement(By.xpath("//input[@id=\"orderMktprotection\" and @name=\"mktprotection\"]")).sendKeys(new FUTSTKMethodTC9().getData2()); //Setting Market Protection value
		 ...
		 if(statuString.equalsIgnoreCase("open"))
		   {
			   ...
			   rupee.navigate().refresh();
			   rupee.findElement(By.xpath("//*[@id=\"backoff\"]/a")).click(); //Clicking on Reports
			   rupee.findElement(By.xpath("//*[@id=\"backoff\"]/ul/li[1]/a")).click(); //Clicking on Orderbook option
			   
			   Thread.sleep(2222);
			   
			   WebElement element1 = rupee.findElement(By.xpath("//div[@id=\"orderBookGrid\"]/div[5]/div/div[8]/div[3]"));
				JavascriptExecutor js1 = (JavascriptExecutor) rupee;

				js1.executeScript("arguments[0].scrollIntoView(true);", element1);
				System.out.println("Scrolled1"+js1);
			   
			   rupee.findElement(By.xpath("//*[@id=\"orderBookGrid\"]/div[5]/div/div[1]/div[5]")).click(); //Clicking on Orderbook list for Modify
