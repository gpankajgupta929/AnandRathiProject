...
import anandrathiFUTSTK.FUTSTKMethodTC24;

import org.testng.annotations.*;

public class FUTSTKTestCase24
{
     @Test (description = "Sell Order Entry > SL-M Order Type > MIS PRODUCT > Validity DAY.")
 ...
 
	{
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"symbollookup\"]")).sendKeys(new FUTSTKMethodTC24().getData0()); //Inputting searching value in Search Pop-Up Screen
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"orderLot\"]")).sendKeys(new FUTSTKMethodTC24().getData1()); //Setting Order Quantity value
	   ...
	   rupee.findElement(By.xpath("//input[@id=\"orderTriggerPrice\" and @name=\"trggprice\"]")).sendKeys(new FUTSTKMethodTC24().getData2()); //Setting Trigger Price
	   
	   rupee.findElement(By.xpath("//input[@id=\"orderMktprotection\" and @name=\"mktprotection\"]")).clear();
	   rupee.findElement(By.xpath("//input[@id=\"orderMktprotection\" and @name=\"mktprotection\"]")).sendKeys(new FUTSTKMethodTC24().getData3()); //Setting Market Protection value
