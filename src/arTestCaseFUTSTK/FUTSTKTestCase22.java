...
import anandrathiFUTSTK.FUTSTKMethodTC22;

import org.testng.annotations.*;

public class FUTSTKTestCase22
{
     @Test (description = "Sell Order Entry > SL-M Order Type > NRML PRODUCT >  Validity DAY.")
 ...
 
	{
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"symbollookup\"]")).sendKeys(new FUTSTKMethodTC22().getData0()); //Inputting searching value in Search Pop-Up Screen
	   ...
	   rupee.findElement(By.id("sell_active")).click(); //Clicking on Buy Action on Placing Order Screen
	   
	   rupee.findElement(By.xpath("//*[@id=\"orderLot\"]")).clear(); //Clearing By-Default value from Quantity field
	   rupee.findElement(By.xpath("//*[@id=\"orderLot\"]")).sendKeys(new FUTSTKMethodTC22().getData1()); //Setting Order Quantity value
	   //sendKeys only accept CharSequences
	   
	   Select drpOrder = new Select(rupee.findElement(By.id("orderType")));
	   drpOrder.selectByVisibleText("SL-M");
	   
	   rupee.findElement(By.xpath("//input[@id=\"orderTriggerPrice\" and @name=\"trggprice\"]")).clear();
	   rupee.findElement(By.xpath("//input[@id=\"orderTriggerPrice\" and @name=\"trggprice\"]")).sendKeys(new FUTSTKMethodTC22().getData2()); //Setting Trigger Price
	   
	   rupee.findElement(By.xpath("//input[@id=\"orderMktprotection\" and @name=\"mktprotection\"]")).clear();
	   rupee.findElement(By.xpath("//input[@id=\"orderMktprotection\" and @name=\"mktprotection\"]")).sendKeys(new FUTSTKMethodTC22().getData3()); //Setting Market Protection value
	   
	   rupee.findElement(By.xpath("//*[@id=\"more_less_fields\"]/h6/a")).click(); //Clicking on More Fields
	   
	   WebElement element1 = rupee.findElement (By.id("btnConfirmOrder"));
	   JavascriptExecutor js1 = (JavascriptExecutor) rupee;
	   
	   js1.executeScript ("arguments[0].click();" , element1); //Clicking Submit Order button
	  ...
	  rupee.findElement(By.xpath("//*[@id=\"backoff\"]/a")).click(); //Clicking on Reports
	   ...
	   String statuString = rupee.findElement(By.xpath("//*[@id=\"orderBookGrid\"]/div[5]/div/div[1]/div[4]")).getText(); //Path for Status Grid Text
		 ...
		 //-->/html/body/section[25]/div/div/div/div/div/div/div[2]/div/div/div/div/div/div[5]/div/div[8]/div[5]
			 ...
			 //*[@id="orderBookGrid"]/div[5]/div/div[1]/div[5]/div
			   ...
			   String statuString1 = rupee.findElement(By.xpath("//*[@id=\"orderBookGrid\"]/div[5]/div/div[1]/div[4]")).getText(); //Path for Status Grid Text
			   //*[@id=\"orderBookGrid\"]/div[5]/div/div[1]/div[4]/div
