...
import anandrathiFUTSTK.FUTSTKMethodTC7;

import org.testng.annotations.*;

public class FUTSTKTestCase7
{
     @Test (description = "Place Order Entry > Limit Order Type > MIS PRODUCT >  Validity IOC.")
 ...
 
	{
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"symbollookup\"]")).sendKeys(new FUTSTKMethodTC7().getData0()); //Inputting searching value in Search Pop-Up Screen
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"orderLot\"]")).sendKeys(new FUTSTKMethodTC7().getData1()); //Setting Order Quantity value
	   ...
	   js1.executeScript("arguments[0].value = " + new FUTSTKMethodTC7().getData2(), dl);
