...
import anandrathiFUTSTK.FUTSTKMethodTC2;

import org.testng.annotations.*;

public class FUTSTKTestCase2 
{
     @Test (description = "Sell Order Entry > Limit Order Type > NRML PRODUCT >  Validity Day only.")
 ...
 
	{
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"symbollookup\"]")).sendKeys(new FUTSTKMethodTC2().getData0()); //Inputting searching value in Search Pop-Up Screen
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"orderLot\"]")).sendKeys(new FUTSTKMethodTC2().getData1()); //Setting Order Quantity value
	   ...
	   js1.executeScript("arguments[0].value = " + new FUTSTKMethodTC2().getData2(), dl);
