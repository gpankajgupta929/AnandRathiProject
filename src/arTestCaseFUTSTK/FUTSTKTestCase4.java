...
import anandrathiFUTSTK.FUTSTKMethodTC4;

import org.testng.annotations.*;

public class FUTSTKTestCase4
{
     @Test (description = "Place Order Entry > Limit Order Type > MIS PRODUCT >  Validity Day only.")
 ...
 
	{
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"symbollookup\"]")).sendKeys(new FUTSTKMethodTC4().getData0()); //Inputting searching value in Search Pop-Up Screen
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"orderLot\"]")).sendKeys(new FUTSTKMethodTC4().getData1()); //Setting Order Quantity value
	   ...
	   js1.executeScript("arguments[0].value = " + new FUTSTKMethodTC4().getData2(), dl);
