...
import anandrathiFUTSTK.FUTSTKMethodTC20;

import org.testng.annotations.*;

public class FUTSTKTestCase20
{
     @Test (description = "Sell Order Entry > SL Order Type > MIS PRODUCT >  Validity DAY.")
 ...
 
	{
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"symbollookup\"]")).sendKeys(new FUTSTKMethodTC20().getData0()); //Inputting searching value in Search Pop-Up Screen
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"orderLot\"]")).sendKeys(new FUTSTKMethodTC20().getData1()); //Setting Order Quantity value
	   ...
	   js1.executeScript("arguments[0].value = " + new FUTSTKMethodTC20().getData2(), dl);
	   ...
	   rupee.findElement(By.xpath("//input[@id=\"orderTriggerPrice\" and @name=\"trggprice\"]")).sendKeys(new FUTSTKMethodTC20().getData3()); //Setting Trigger Price
