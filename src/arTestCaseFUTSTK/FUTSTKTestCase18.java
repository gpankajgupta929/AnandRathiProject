...
import anandrathiFUTSTK.FUTSTKMethodTC18;

import org.testng.annotations.*;

public class FUTSTKTestCase18
{
     @Test (description = "Sell Order Entry > SL Order Type > NRML PRODUCT >  Validity DAY.")
 ...
 
	{
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"symbollookup\"]")).sendKeys(new FUTSTKMethodTC18().getData0()); //Inputting searching value in Search Pop-Up Screen
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"orderLot\"]")).sendKeys(new FUTSTKMethodTC18().getData1()); //Setting Order Quantity value
	   ...
	   js1.executeScript("arguments[0].value = " + new FUTSTKMethodTC18().getData2(), dl);
	   
	   rupee.findElement(By.xpath("//input[@id=\"orderTriggerPrice\" and @name=\"trggprice\"]")).clear();
	   rupee.findElement(By.xpath("//input[@id=\"orderTriggerPrice\" and @name=\"trggprice\"]")).sendKeys(new FUTSTKMethodTC18().getData3()); //Setting Trigger Price
