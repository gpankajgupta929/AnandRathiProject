...
import anandrathiFUTSTK.FUTSTKMethodTC17;

import org.testng.annotations.*;

public class FUTSTKTestCase17
{
     @Test (description = "Buy Order Entry > SL Order Type > NRML PRODUCT >  Validity DAY.")
 ...
 
	{
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"symbollookup\"]")).sendKeys(new FUTSTKMethodTC17().getData0()); //Inputting searching value in Search Pop-Up Screen
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"orderLot\"]")).sendKeys(new FUTSTKMethodTC17().getData1()); //Setting Order Quantity value
	   ...
	   js1.executeScript("arguments[0].value = " + new FUTSTKMethodTC17().getData2(), dl);
	   
	   rupee.findElement(By.xpath("//input[@id=\"orderTriggerPrice\" and @name=\"trggprice\"]")).clear();
	   rupee.findElement(By.xpath("//input[@id=\"orderTriggerPrice\" and @name=\"trggprice\"]")).sendKeys(new FUTSTKMethodTC17().getData3()); //Setting Trigger Price
