...
import anandrathiFUTSTK.FUTSTKMethodTC6;

import org.testng.annotations.*;

public class FUTSTKTestCase6
{
     @Test (description = "Sell Order Entry > Limit Order Type > MIS PRODUCT >  Validity IOC.")
 ...
 
	{
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"symbollookup\"]")).sendKeys(new FUTSTKMethodTC6().getData0()); //Inputting searching value in Search Pop-Up Screen
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"orderLot\"]")).sendKeys(new FUTSTKMethodTC6().getData1()); //Setting Order Quantity value
	   ...
	   js1.executeScript("arguments[0].value = " + new FUTSTKMethodTC6().getData2(), dl);
