...
import anandrathiFUTSTK.FUTSTKMethodTC10;

import org.testng.annotations.*;

public class FUTSTKTestCase10 
{
     @Test (description = "Sell Order Entry > MKT Order Type > NRML PRODUCT > Validity Day.")
 ...
 
	{
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"symbollookup\"]")).sendKeys(new FUTSTKMethodTC10().getData0()); //Inputting searching value in Search Pop-Up Screen
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"orderLot\"]")).sendKeys(new FUTSTKMethodTC10().getData1()); //Setting Order Quantity value
	   ...
	   rupee.findElement(By.xpath("//input[@id=\"orderMktprotection\" and @name=\"mktprotection\"]")).sendKeys(new FUTSTKMethodTC10().getData2()); //Setting Market Protection value
