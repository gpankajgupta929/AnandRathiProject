...
import anandrathiFUTCUR.FUTCURMethodTC20;

import org.testng.annotations.*;

public class FUTCURTestCase20 
{
     @Test (description = "Sell Order Entry > NRML PRODUCT > SL-M Order Type > Validity Day.")
 ...
 
	{
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"symbollookup\"]")).sendKeys(new FUTCURMethodTC20().getData0()); //Inputting searching value in Search Pop-Up Screen
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"orderLot\"]")).sendKeys(new FUTCURMethodTC20().getData1()); //Setting Order Quantity value
	   ...
	   rupee.findElement(By.xpath("//input[@id=\"orderTriggerPrice\" and @name=\"trggprice\"]")).sendKeys(new FUTCURMethodTC20().getData2()); //Setting Trigger Price
	   ...
	   rupee.findElement(By.xpath("//input[@id=\"orderDisclosedQuantity\" and @name=\"discqty\"]")).sendKeys(new FUTCURMethodTC20().getData3()); //Setting Disclose Quantity
		 ...
		 if(statuString.equalsIgnoreCase("trigger pending"))
		   {
			   ...
			   rupee.findElement(By.xpath("//div[@id=\"orderBookGrid\"]/div[5]/div/div[1]/div[5]")).click(); //Clicking on Orderbook list for Modify
