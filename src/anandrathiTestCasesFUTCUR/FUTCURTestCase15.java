...
import anandrathiFUTCUR.FUTCURMethodTC15;

import org.testng.annotations.*;

public class FUTCURTestCase15 
{
     @Test (description = "Place Order Entry > NRML PRODUCT > MKT Order Type > Validity IOC.")
 ...
 
	{
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"symbollookup\"]")).sendKeys(new FUTCURMethodTC15().getData0()); //Inputting searching value in Search Pop-Up Screen
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"orderLot\"]")).sendKeys(new FUTCURMethodTC15().getData1()); //Setting Order Quantity value
	   ...
	   rupee.findElement(By.xpath("//input[@id=\"orderMktprotection\" and @name=\"mktprotection\"]")).sendKeys(new FUTCURMethodTC15().getData2()); //Setting Market Protection value
