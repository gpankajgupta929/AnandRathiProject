...
import anandrathiFUTCUR.FUTCURMethodTC3;

import org.testng.annotations.*;

public class FUTCURTestCase3 
{
     @Test (description = "Place Order Entry > MIS PRODUCT > Limit Order Type > Validity day only.")
 ...
 
	{
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"symbollookup\"]")).sendKeys(new FUTCURMethodTC3().getData0()); //Inputting searching value in Search Pop-Up Screen
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"orderLot\"]")).sendKeys(new FUTCURMethodTC3().getData1()); //Setting Order Quantity value
	   ...
	   js1.executeScript("arguments[0].value = " + new FUTCURMethodTC3().getData2(), dl);
	   ...
	   rupee.findElement(By.xpath("//input[@id=\"orderDisclosedQuantity\" and @name=\"discqty\"]")).sendKeys(new FUTCURMethodTC3().getData3()); //Setting Disclose Quantity
