...
import anandrathiFUTCUR.FUTCURMethodTC6;

import org.testng.annotations.*;

public class FUTCURTestCase6 
{
     @Test (description = "Sell Order Entry > NRML PRODUCT > Limit Order Type > Validity IOC.")
 ...
 
	{
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"symbollookup\"]")).sendKeys(new FUTCURMethodTC6().getData0()); //Inputting searching value in Search Pop-Up Screen
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"orderLot\"]")).sendKeys(new FUTCURMethodTC6().getData1()); //Setting Order Quantity value
	   ...
	   js1.executeScript("arguments[0].value = " + new FUTCURMethodTC6().getData2(), dl);
