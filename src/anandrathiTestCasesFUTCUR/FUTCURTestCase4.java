...
import anandrathiFUTCUR.FUTCURMethodTC4;

import org.testng.annotations.*;

public class FUTCURTestCase4 
{
     @Test (description = "Sell Order Entry > MIS PRODUCT > Limit Order Type > Validity day only.")
 ...
 
	{
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"symbollookup\"]")).sendKeys(new FUTCURMethodTC4().getData0()); //Inputting searching value in Search Pop-Up Screen
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"orderLot\"]")).sendKeys(new FUTCURMethodTC4().getData1()); //Setting Order Quantity value
	   ...
	   js1.executeScript("arguments[0].value = " + new FUTCURMethodTC4().getData2(), dl);
	   ...
	   rupee.findElement(By.xpath("//input[@id=\"orderDisclosedQuantity\" and @name=\"discqty\"]")).sendKeys(new FUTCURMethodTC4().getData3()); //Setting Disclose Quantity
