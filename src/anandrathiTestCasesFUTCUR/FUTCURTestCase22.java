...
import anandrathiFUTCUR.FUTCURMethodTC22;

import org.testng.annotations.*;

public class FUTCURTestCase22 
{
 ...
 
	{
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"symbollookup\"]")).sendKeys(new FUTCURMethodTC22().getData0()); //Inputting searching value in Search Pop-Up Screen
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"orderLot\"]")).sendKeys(new FUTCURMethodTC22().getData1()); //Setting Order Quantity value
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"orderTriggerPrice\"]")).clear();
	   
	   rupee.findElement(By.xpath("//*[@id=\"orderTriggerPrice\"]")).sendKeys(new FUTCURMethodTC22().getData2()); //Setting Trigger Price
	   
	   rupee.findElement(By.xpath("//input[@id=\"orderMktprotection\" and @name=\"mktprotection\"]")).clear();
	   
	   rupee.findElement(By.xpath("//input[@id=\"orderMktprotection\" and @name=\"mktprotection\"]")).sendKeys(new FUTCURMethodTC22().getData3()); //Setting Market Protection value
	   
	   rupee.findElement(By.xpath("//*[@id=\"more_less_fields\"]/h6/a")).click(); //Clicking on More Field
	   
	   Thread.sleep(2200);
	   
	   rupee.findElement(By.xpath("//input[@id=\"orderDisclosedQuantity\" and @name=\"discqty\"]")).sendKeys(new FUTCURMethodTC22().getData4()); //Setting Disclose Quantity
