...
import anandrathiFUTCUR.FUTCURMethodTC7;

import org.testng.annotations.*;

public class FUTCURTestCase7 
{
     @Test (description = "Place Order Entry > MIS PRODUCT > Limit Order Type > Validity IOC.")
 ...
 
	{
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"symbollookup\"]")).sendKeys(new FUTCURMethodTC7().getData0()); //Inputting searching value in Search Pop-Up Screen
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"orderLot\"]")).sendKeys(new FUTCURMethodTC7().getData1()); //Setting Order Quantity value
	   ...
	   js1.executeScript("arguments[0].value = " + new FUTCURMethodTC7().getData2(), dl);
