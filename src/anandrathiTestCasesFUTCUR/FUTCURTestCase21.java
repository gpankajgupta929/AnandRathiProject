...
import anandrathiFUTCUR.FUTCURMethodTC21;

import org.testng.annotations.*;

public class FUTCURTestCase21 
{
     @Test (description = "Sell Order Entry > NRML PRODUCT > MKT Order Type > Validity Day.")
 ...
 
	{
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"symbollookup\"]")).sendKeys(new FUTCURMethodTC21().getData0()); //Inputting searching value in Search Pop-Up Screen
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"orderLot\"]")).sendKeys(new FUTCURMethodTC21().getData1()); //Setting Order Quantity value
	   ...
	   rupee.findElement(By.xpath("//input[@id=\"orderMktprotection\" and @name=\"mktprotection\"]")).sendKeys(new FUTCURMethodTC21().getData2()); //Setting Market Protection value
	   
	   rupee.findElement(By.xpath("//*[@id=\"more_less_fields\"]/h6/a")).click(); //Clicking on More Field
	   
	   Thread.sleep(2200);
	   
	   rupee.findElement(By.xpath("//input[@id=\"orderDisclosedQuantity\" and @name=\"discqty\"]")).sendKeys(new FUTCURMethodTC21().getData3()); //Setting Disclose Quantity
