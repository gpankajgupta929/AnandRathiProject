...
import anandrathiFUTCUR.FUTCURMethodTC18;

import org.testng.annotations.*;

public class FUTCURTestCase18 
{
     @Test (description = "Sell Order Entry > MIS PRODUCT > SL Order Type > Validity Day.")
 ...
 
	{
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"symbollookup\"]")).sendKeys(new FUTCURMethodTC18().getData0()); //Inputting searching value in Search Pop-Up Screen
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"orderLot\"]")).sendKeys(new FUTCURMethodTC18().getData1()); //Setting Order Quantity value
	   //sendKeys only accept CharSequences
	   
	   Select drpOrder = new Select(rupee.findElement(By.id("orderType")));
	   drpOrder.selectByVisibleText("SL");
	   ...
	   js1.executeScript("arguments[0].value = " + new FUTCURMethodTC18().getData2(), dl);
	   
	   Select drpOrderProduct = new Select(rupee.findElement(By.id("orderProduct")));
	   drpOrderProduct.selectByVisibleText("MIS");

	   rupee.findElement(By.xpath("//input[@id=\"orderTriggerPrice\" and @name=\"trggprice\"]")).clear();
	   
	   rupee.findElement(By.xpath("//input[@id=\"orderTriggerPrice\" and @name=\"trggprice\"]")).sendKeys(new FUTCURMethodTC18().getData3()); //Setting Trigger Price
	   
	   rupee.findElement(By.xpath("//*[@id=\"more_less_fields\"]/h6/a")).click(); //Clicking on More Field
	   
	   Thread.sleep(2200);
	   
	   rupee.findElement(By.xpath("//input[@id=\"orderDisclosedQuantity\" and @name=\"discqty\"]")).clear();
	   rupee.findElement(By.xpath("//input[@id=\"orderDisclosedQuantity\" and @name=\"discqty\"]")).sendKeys(new FUTCURMethodTC18().getData4()); //Setting Disclose Quantity
	  ...
	  rupee.findElement(By.xpath("//*[@id=\"backoff\"]/a")).click(); //Clicking on Reports
	   ...
	   String statuString = rupee.findElement(By.xpath("//div[@id=\"orderBookGrid\"]/div[5]/div/div[1]/div[4]")).getText(); //Path for Status Grid Text
	   
	 //div[@id=\"orderBookGrid\"]/div[5]/div/div[1]/div[4]
		//*[@id="orderBookGrid"]/div[5]/div/div[1]/div[4]/div
	   
		 if(statuString.equalsIgnoreCase("trigger pending"))
		   {
			   System.out.println("Text is present.");
			   
			   Thread.sleep(2000);
			   rupee.findElement(By.xpath("/html/body/section[25]/div/div/div/div/div/div/div[2]/div/div/div/div/div/div[5]/div/div[1]/div[5]/div")).click(); //Clicking on Orderbook list for Modify
			   //-->/html/body/section[25]/div/div/div/div/div/div/div[2]/div/div/div/div/div/div[5]/div/div[1]/div[5]/div
		 ...
		 //-->/html/body/section[25]/div/div/div/div/div/div/div[2]/div/div/div/div/div/div[5]/div/div[8]/div[5]
			 ...
			 //div[@id=\"orderBookGrid\"]/div[5]/div/div[1]/div[4]
			   //*[@id="orderBookGrid"]/div[5]/div/div[1]/div[4]/div
				 ...
				 if(statuString1.equalsIgnoreCase("trigger pending"))
				   {
