...
import anandrathiFUTCUR.FUTCURMethodTC12;

import org.testng.annotations.*;

public class FUTCURTestCase12 
{
     @Test (description = "Sell Order Entry > NRML PRODUCT > SL Order Type > Validity Day.")
 ...
 
	{
		 ...
		 rupee.manage().window().maximize();
		   ...
		   rupee.findElement(By.xpath("//*[@id=\"id\"]")).sendKeys(new FUTCURMethodTC1().getData()); //Inputting User ID
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"symbollookup\"]")).sendKeys(new FUTCURMethodTC12().getData0()); //Inputting searching value in Search Pop-Up Screen
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"orderLot\"]")).sendKeys(new FUTCURMethodTC12().getData1()); //Setting Order Quantity value
	   ...
	   js1.executeScript("arguments[0].value = " + new FUTCURMethodTC12().getData2(), dl);
	   
       rupee.findElement(By.xpath("//input[@id=\"orderTriggerPrice\" and @name=\"trggprice\"]")).clear();
	   
	   rupee.findElement(By.xpath("//input[@id=\"orderTriggerPrice\" and @name=\"trggprice\"]")).sendKeys(new FUTCURMethodTC12().getData3()); //Setting Trigger Price

	   rupee.findElement(By.xpath("//*[@id=\"more_less_fields\"]/h6/a")).click(); //Clicking on More Fields
	   
	   rupee.findElement(By.xpath("//input[@id=\"orderDisclosedQuantity\" and @name=\"discqty\"]")).sendKeys(new FUTCURMethodTC12().getData4()); //Setting Disclose Quantity
