...
import anandrathiFUTCUR.FUTCURMethodTC5;

import org.testng.annotations.*;

public class FUTCURTestCase5 
{
     @Test (description = "Place Order Entry > NRML PRODUCT > Limit Order Type > Validity IOC.")
 ...
 
	{
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"symbollookup\"]")).sendKeys(new FUTCURMethodTC5().getData0()); //Inputting searching value in Search Pop-Up Screen
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"orderLot\"]")).sendKeys(new FUTCURMethodTC5().getData1()); //Setting Order Quantity value
	   ...
	   js1.executeScript("arguments[0].value = " + new FUTCURMethodTC5().getData2(), dl);
