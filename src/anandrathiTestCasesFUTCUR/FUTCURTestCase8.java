...
import anandrathiFUTCUR.FUTCURMethodTC8;

import org.testng.annotations.*;

public class FUTCURTestCase8 
{
     @Test (description = "Sell Order Entry > MIS PRODUCT > Limit Order Type > Validity IOC.")
 ...
 
	{
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"symbollookup\"]")).sendKeys(new FUTCURMethodTC8().getData0()); //Inputting searching value in Search Pop-Up Screen
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"orderLot\"]")).sendKeys(new FUTCURMethodTC8().getData1()); //Setting Order Quantity value
	   ...
	   js1.executeScript("arguments[0].value = " + new FUTCURMethodTC8().getData2(), dl);
	   ...
	   String statuString1 = rupee.findElement(By.xpath("/html/body/section[25]/div/div/div/div/div/div/div[2]/div/div/div/div/div/div[5]/div/div[1]/div[4]")).getText(); //Path for Status Grid Text
		 if(statuString1.equalsIgnoreCase("completed"))
		   ...
		   else
		   {
			   ...
			   System.out.println("Order got Cancelled.");
