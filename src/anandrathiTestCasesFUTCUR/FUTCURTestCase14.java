...
import anandrathiFUTCUR.FUTCURMethodTC14;

import org.testng.annotations.*;

public class FUTCURTestCase14 
{
     @Test (description = "Sell Order Entry > MIS PRODUCT > SL-M Order Type > Validity Day.")
 ...
 
	{
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"symbollookup\"]")).sendKeys(new FUTCURMethodTC14().getData0()); //Inputting searching value in Search Pop-Up Screen
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"orderLot\"]")).sendKeys(new FUTCURMethodTC14().getData1()); //Setting Order Quantity value
	   ...
	   rupee.findElement(By.xpath("//input[@id=\"orderTriggerPrice\" and @name=\"trggprice\"]")).sendKeys(new FUTCURMethodTC14().getData2()); //Setting Trigger Price
	   ...
	   rupee.findElement(By.xpath("//input[@id=\"orderDisclosedQuantity\" and @name=\"discqty\"]")).sendKeys(new FUTCURMethodTC14().getData3()); //Setting Disclose Quantity
