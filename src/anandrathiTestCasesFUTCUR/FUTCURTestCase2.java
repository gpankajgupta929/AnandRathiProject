...
import anandrathiFUTCUR.FUTCURMethodTC2;

import org.testng.annotations.*;

public class FUTCURTestCase2 
{
     @Test (description = "Sell Order Entry > NRML PRODUCT > Limit Order Type > Validity day only.")
 ...
 
	{
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"symbollookup\"]")).sendKeys(new FUTCURMethodTC2().getData0()); //Inputting searching value in Search Pop-Up Screen
	   ...
	   rupee.findElement(By.xpath("//*[@id=\"orderLot\"]")).sendKeys(new FUTCURMethodTC2().getData1()); //Setting Order Quantity value
	   ...
	   js1.executeScript("arguments[0].value = " + new FUTCURMethodTC2().getData2(), dl);
	   
	   rupee.findElement(By.xpath("//*[@id=\"more_less_fields\"]/h6/a")).click(); //Clicking on More Fields
	   
	   rupee.findElement(By.xpath("//input[@id=\"orderDisclosedQuantity\" and @name=\"discqty\"]")).sendKeys(new FUTCURMethodTC2().getData3()); //Setting Disclose Quantity
	   ...
	   rupee.findElement(By.xpath("//button[contains(text(),'OK')]")).click(); //Clicking Ok button of Confirm Message screen
	   
	 //div[@id="Confirmscreen"]/div/div/div/div/div[3]/button
	 //button[contains(text(),'OK')]
	   //-->/html/body/section[5]/div/div/div/div/div/div[3]/button[1]
