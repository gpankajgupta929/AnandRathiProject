...

{
	...
	String data1 = sheet1.getRow(36).getCell(3).getStringCellValue();
...
public String getData1() throws Exception 
{
	...
	int data2 = (int) sheet1.getRow(36).getCell(5).getNumericCellValue();
...
public String getData2() throws Exception 
{
	...
	int data3 = (int) sheet1.getRow(36).getCell(10).getNumericCellValue();
