...

{
	...
	String data1 = sheet1.getRow(40).getCell(3).getStringCellValue();
...
public String getData1() throws Exception 
{
	...
	int data2 = (int) sheet1.getRow(40).getCell(5).getNumericCellValue();
...
public String getData2() throws Exception 
{
	...
	double data3 = (double) sheet1.getRow(40).getCell(7).getNumericCellValue();
...
public String getData3() throws Exception 
{
	...
	int data4 = (int) sheet1.getRow(40).getCell(9).getNumericCellValue();
...
public String getData4() throws Exception 
{
	...
	int data5 = (int) sheet1.getRow(40).getCell(12).getNumericCellValue();
	
	String str= Integer.toString(data5);
	
	System.out.println("Data from Excel Sheet is.:" + data5);
