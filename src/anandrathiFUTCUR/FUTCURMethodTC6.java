...

{
	...
	String data1 = sheet1.getRow(12).getCell(3).getStringCellValue();
...
public String getData1() throws Exception 
{
	...
	int data2 = (int) sheet1.getRow(12).getCell(5).getNumericCellValue();
...
public String getData2() throws Exception 
{
	...
	double data3 = (double) sheet1.getRow(12).getCell(7).getNumericCellValue();
